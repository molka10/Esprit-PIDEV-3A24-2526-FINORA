...
public class ServiceChatbot {
    ...
    private static final String API_KEY = "AIzaSyALSljEpDrE0BIj4JwGZV9MUPkPCqkEilM";

    // Historique conversation : role = "user" ou "model"
    private final List<Map<String, String>> history = new ArrayList<>();

    private static final String SYSTEM_PROMPT = "Tu es un conseiller financier expert intégré dans FINORA, une plateforme de trading boursier tunisienne.\n"
            +
