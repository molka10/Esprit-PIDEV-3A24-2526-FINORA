...
// Parent import removed as it's no longer used
...
public class UserController {
    ...
    @FXML
    private LineChart<String, Number> outcomeChart;
    @FXML
    private PieChart pieChart;
    @FXML
    private Label averageLabel;
    @FXML
    private FlowPane monthlyContainer;
    @FXML
    ...
    @FXML
    private ListView<HBox> wishlistView;
    ...
    public void initialize() {
        ...
        if (com.example.finora.utils.Session.getCurrentUser() != null) {
            currentUserId = com.example.finora.utils.Session.getCurrentUser().getId();
        }
    ...
    public void loadTransactions() {
        ...
        for (transaction t : st.afficherParUser(currentUserId)) {
            ...
            XYChart.Data<String, Number> data = new XYChart.Data<>(categorie, Math.abs(montant));
            ...
            data.nodeProperty().addListener((obs, oldNode, newNode) -> {
                if (newNode != null) {
                    newNode.setOnMouseClicked(e -> showTransactionDetails(currentTransaction));
                }
            });
            totalTransactions++;
    ...
    private void openAddTransaction(String type) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/wallet/add-transaction.fxml"));
    ...
    private void showError(String message) {
        NotificationService.show("Erreur", message, NotificationService.NotificationType.ERROR);
    }
    ...
    private void exportPDF() {
        ...
        try {
            ...
            document.add(new Paragraph("Date d'export : " + LocalDate.now()));
            document.add(new Paragraph(" "));
            ...
            for (transaction t : st.afficherParUser(currentUserId)) {
                ...
                table.addCell(t.getNom_transaction() != null ? t.getNom_transaction() : "N/A");
                table.addCell(t.getType() != null ? t.getType() : "N/A");
                table.addCell(t.getCategorie() != null ? t.getCategorie() : "N/A");
    ...
    private void exportExcel() {
        ...
        try {
            ...
            e.printStackTrace();
            NotificationService.show("Erreur Export", "Impossible de générer le fichier Excel.",
    ...
    private void addWishlistItem() {
        ...
        try {
            ...
            sw.ajouter(new Wishlist(currentUserId, name, price));

            loadWishlist();

            itemField.clear();
            priceField.clear();
            NotificationService.show("Succès", name + " a été ajouté à votre wishlist !",
                    NotificationService.NotificationType.SUCCESS);

        } catch (Exception e) {
            NotificationService.show("Attention", "Le montant saisi est invalide.",
    ...
    private void loadWishlist() {
        ...
        for (Wishlist w : sw.afficher(currentUserId)) {
            ...
            deleteBtn.setOnAction(e -> {
                ...
                NotificationService.show("Suppression", w.getName() + " retiré de la liste.",
    ...
    // goBack removed as navigation is handled by sidebar
    ...
    private void predictFutureSpending() {
        ...
        try {
            ...
            NotificationService.show("Analyse IA", "Votre rapport financier est prêt !",
                    NotificationService.NotificationType.INFO);

        } catch (Exception e) {
            aiResultLabel.setText("Erreur IA: " + e.getMessage());
            NotificationService.show("Erreur IA", "L'analyse n'a pas pu aboutir.",
                    NotificationService.NotificationType.ERROR);
        }
    }
