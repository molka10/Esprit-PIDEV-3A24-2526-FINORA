...
public class AddTransactionController {
    ...
    private void loadCategoriesByType(String type) {
        ...
        List<categorie> list = sc.getByUserAndType(currentUserId, type);
    ...
    private void openAddCategory() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/wallet/add-category.fxml"));
            ...
            controller.setUserId(currentUserId);   // 🔥 هذا هو الناقص
