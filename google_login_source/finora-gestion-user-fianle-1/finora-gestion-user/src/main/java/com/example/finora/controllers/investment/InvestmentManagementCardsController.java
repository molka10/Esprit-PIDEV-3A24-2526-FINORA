...
public class InvestmentManagementCardsController {
    ...
    @FXML
    private Label totalManagementLabel;
    @FXML
    private Label totalInvestedLabel;
    @FXML
    private Label activeRatioLabel;
    ...
    private void onAdd() {
        ...
        SceneNavigator.goTo("/investment/investment_management_form.fxml",
    ...
    private void goToInvestments() {
        SceneNavigator.goTo("/investment/investment_cards.fxml", "Investments");
    }

    @FXML
    private ScrollPane managementRoot;
    ...
    private void toggleDarkMode() {
        ...
        if (managementRoot.getStyleClass().contains("dark-root")) {
            managementRoot.getStyleClass().remove("dark-root");
        } else {
            managementRoot.getStyleClass().add("dark-root");
        }
    }
    ...
    private void loadStatistics(List<InvestmentManagement> list) {
        ...
        totals.forEach((type, total) -> {
            ...
            XYChart.Data<String, Number> data = new XYChart.Data<>(type, 0.0);
