...
public class GoogleAuthService {
    ...
    private static final String CLIENT_ID = getEnvOrDefault("GOOGLE_CLIENT_ID", "YOUR_CLIENT_ID_HERE");
    private static final String CLIENT_SECRET = getEnvOrDefault("GOOGLE_CLIENT_SECRET", "YOUR_CLIENT_SECRET_HERE");
