...
public class AdminShellController {
    ...
    @FXML
    public void goGestionBourses(ActionEvent event) {
        loadCenterSafe("/bourse/bourse-view.fxml");
    }

    @FXML
    public void goGestionActions(ActionEvent event) {
        loadCenterSafe("/bourse/action-view.fxml");
    }

    @FXML
    public void goCommissions(ActionEvent event) {
        loadCenterSafe("/bourse/Commission view.fxml");
    }

    @FXML
    public void goSupervision(ActionEvent event) {
