...
public class EntrepriseShellController {
    ...
    private static EntrepriseShellController instance;

    public static EntrepriseShellController getInstance() {
        return instance;
    }
    ...
    public void initialize() {
        ...
        if (user != null) {
            ...
            String initial = (name != null && !name.isEmpty()) ? name.substring(0, 1).toUpperCase() : "E";
        ...
        // Automatically load enterprise wallet on start
        loadCenterSafe("/wallet/entreprise.fxml");
    }
    ...
    @FXML
    private void goEntrepriseHome(ActionEvent event) {
    ...
    @FXML
    private void goBourseDashboard(ActionEvent event) {
