...
import com.example.finora.services.appeldoffre.PdfExportService;
...
public class AppelOffreController {
    ...
    @FXML
    private ListView<AppelOffre> listView;
    ...
    @FXML
    private PieChart statutPie;
    @FXML
    private BarChart<String, Number> candidatureBar;
    ...
    private void onNew() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/AppelOffreForm.fxml"));
