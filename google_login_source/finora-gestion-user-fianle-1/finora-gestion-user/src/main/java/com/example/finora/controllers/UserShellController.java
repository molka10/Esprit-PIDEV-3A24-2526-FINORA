...
public class UserShellController {
    ...
    private static UserShellController instance;

    public static UserShellController getInstance() {
        return instance;
    }
    ...
    public void initialize() {
        ...
        if (user != null) {
            ...
            NotificationService.setContainer(toastContainer);
            NotificationService.show("Bienvenue 👋", "Content de vous revoir sur Finora !",
                    NotificationService.NotificationType.INFO);

            // ✅ Load dashboard by default
            loadCenterSafe("dashboard-user.fxml");
        }
    }
    ...
    private void goBourse(ActionEvent event) {
        loadCenterSafe("/bourse/dashboard-investisseur-view.fxml");
    }

    @FXML
    private void goOrdres(ActionEvent event) {
        loadCenterSafe("/bourse/action-view.fxml");
    }

    @FXML
    private void goHistorique(ActionEvent event) {
        loadCenterSafe("/bourse/Historique view.fxml");
    }
    ...
    private void goPortefeuille(ActionEvent event) {
        loadCenterSafe("/wallet/user.fxml");
    }
    ...
    @FXML
    private void goInvestment(ActionEvent event) {
        loadCenterSafe("/investment/investment_cards.fxml");
    }
