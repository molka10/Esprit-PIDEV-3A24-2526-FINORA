...
public class ThemeManager {
    ...
    private static final String LIGHT_CSS = "/com/example/finora/ui/styles/theme-light.css";
    private static final String DARK_CSS  = "/com/example/finora/ui/styles/theme-dark.css";
