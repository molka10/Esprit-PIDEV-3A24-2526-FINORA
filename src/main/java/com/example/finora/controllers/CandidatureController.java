...
public class CandidatureController {
    ...
    @FXML private ComboBox<AppelOffre> appelOffreFilterCombo;
    ...
    private void loadData() {
        try {
            List<Candidature> all = candidatureService.getAll();
            data.setAll(all);
            listView.refresh();
    ...
    private void applySearchFilter(String keyword) {
        ...
        if (ao != null) {
            ...
            for (Candidature c : data) {
                if (c.getAppelOffreId() == id) base.add(c);
            }
        }
    ...
    private void onNew() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/finora/ui/CandidatureForm.fxml"));
