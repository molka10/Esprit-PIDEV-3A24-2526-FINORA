...
public class LessonFormController {
    ...
    public void setFormations(List<Formation> formations, Formation preselected) {
        ...
        if (preselected != null)
            cbFormation.getSelectionModel().select(preselected);
    }
    ...
    public void setData(Lesson l) {
        ...
        if (l != null) {
            if (lblTitle != null)
                lblTitle.setText("Modifier Lesson");
            ...
            if (lblTitle != null)
                lblTitle.setText("Ajouter Lesson");
        }
    }
