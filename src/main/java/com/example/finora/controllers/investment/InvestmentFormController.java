...
public class InvestmentFormController {
    ...
    @FXML
    private ComboBox<String> currencyCombo; // 💱 NEW
    @FXML
    private ComboBox<String> riskCombo;
    ...
    private void onSave() {
        ...
        try {
            if (editing == null) {
                ...
                // ✅ Record in Wallet as outcome
                try {
                    int userId = Session.getCurrentUser().getId();
                    WalletBridge.recordInvestment(userId, inv.getName(),
                            inv.getEstimatedValue().doubleValue());
