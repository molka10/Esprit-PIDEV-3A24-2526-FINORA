package com.example.finora.controllers.investment;
...
public class InvestmentManagementFormController {
    ...
    @FXML
    private ComboBox<Investment> investmentCombo;
    @FXML
    ...
    @FXML
    private Label investmentErrorLabel;
    @FXML
    private Label typeErrorLabel;
    @FXML
    private Label amountErrorLabel;
    @FXML
    private Label percentErrorLabel;
    @FXML
    ...
    @FXML
    private ProgressBar fundingProgressBar;
    @FXML
    private Label fundingPercentLabel;
    @FXML
    private Label fundingStatusBadge;
    ...
    private void onCancel() {
        ...
        SceneNavigator.goTo(
                "/investment/investment_management_cards.fxml",
    ...
    private void updateBusinessView() {
        ...
        try {
            ...
            exposureLabel.setText("$" + exposure.setScale(2, java.math.RoundingMode.HALF_UP));
    ...
    private void onSave() {
        ...
        BigDecimal existingOwnership = service.getTotalOwnershipForInvestment(inv.getInvestmentId());

        if (editing != null && editing.getOwnershipPercentage() != null) {
            existingOwnership = existingOwnership.subtract(editing.getOwnershipPercentage());
        }
