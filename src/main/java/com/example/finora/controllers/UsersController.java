...
public class UsersController {
    ...
    @FXML
    private ToggleButton toggleRole;
    ...
    private static class UserCardCell extends ListCell<User> {
        ...
        protected void updateItem(User user, boolean empty) {
            ...
            Node g = getGraphic();
            if (isSelected())
                g.getStyleClass().add("user-card-selected");
            else
                g.getStyleClass().remove("user-card-selected");
        }
        ...
        public void updateSelected(boolean selected) {
            ...
            if (getGraphic() == null)
                return;
            if (selected)
                getGraphic().getStyleClass().add("user-card-selected");
            else
                getGraphic().getStyleClass().remove("user-card-selected");
        }
