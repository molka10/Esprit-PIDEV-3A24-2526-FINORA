 ...
 */
public class TransactionBourse {
    ...
    // Constructeurs
    public TransactionBourse() {
    }

    public TransactionBourse(int idAction, String typeTransaction,
    ...
    public void setIdTransaction(int v) {
        idTransaction = v;
    }
    ...
    public void setTypeTransaction(String v) {
        typeTransaction = v;
    }
    ...
    public void setPrixUnitaire(double v) {
        prixUnitaire = v;
    }
    ...
    public void setMontantTotal(double v) {
        montantTotal = v;
    }
    ...
    public void setDateTransaction(Timestamp v) {
        dateTransaction = v;
    }
    ...
    public String getActeurRole() {
        return acteurRole;
    }

    public void setActeurRole(String acteurRole) {
        this.acteurRole = acteurRole;
    }

    public String getActeurLabel() {
        return acteurLabel;
    }

    public void setActeurLabel(String acteurLabel) {
    ...
    /**
     * Montant net = total + commission pour un achat, total - commission pour une
     * vente
     */
    ...
    public String getActeurAffichage() {
        if (acteurLabel != null && !acteurLabel.isBlank())
            return acteurLabel;
    ...
    public String toString() {
        return "TransactionBourse{id=" + idTransaction +
