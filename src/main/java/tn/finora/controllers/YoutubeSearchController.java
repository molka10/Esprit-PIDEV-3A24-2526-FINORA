...
public class YoutubeSearchController {
    ...
    @FXML private Label lblLessonTitle;

    @FXML private HBox currentVideoRow;
    @FXML private Label lblCurrentVideo;
    ...
    public void setLesson(Lesson lesson) {
        ...
        if (txtQuery != null) txtQuery.setText(safe(lesson.getTitre(), ""));
    ...
    private String mapOrder(String uiValue) {
        if (uiValue == null) return "relevance";
