...
final class CentreFormationController extends AbstractController
{
    ...
    //  ADMIN — List
    // ────────────────────────────────────────────────────────────────
    #[Route('', name: 'admin_centres_index', methods: ['GET'])]
    ...
    //  ADMIN — New
    // ────────────────────────────────────────────────────────────────
    #[Route('/nouveau', name: 'admin_centres_new', methods: ['GET', 'POST'])]
    ...
    //  ADMIN — Edit
    // ────────────────────────────────────────────────────────────────
    #[Route('/{id}/modifier', name: 'admin_centres_edit', methods: ['GET', 'POST'])]
    ...
    //  ADMIN — Delete
    // ────────────────────────────────────────────────────────────────
    #[Route('/{id}/supprimer', name: 'admin_centres_delete', methods: ['POST'])]
    ...
    // ────────────────────────────────────────────────────────────────
    #[Route('/api/centres.json', name: 'api_centres_json', methods: ['GET'])]
    public function apiCentres(EntityManagerInterface $em): JsonResponse
    {
        $centres = $em->getRepository(CentreFormation::class)->findBy(['isActive' => true]);

        $data = array_map(fn(CentreFormation $c) => [
            'id'          => $c->getId(),
            'nom'         => $c->getNom(),
